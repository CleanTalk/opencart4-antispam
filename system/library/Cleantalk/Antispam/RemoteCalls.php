...
class RemoteCalls
{
    ...
    {
        return isset($_GET['spbc_remote_call_token'], $_GET['spbc_remote_call_action'], $_GET['plugin_name']) && in_array(
            Get::get('plugin_name'),
            ...
            if ( strtolower($token) == strtolower(md5($apikey)) ) {
                switch ( $action ) {
                    ...
                    case 'sfwUpdate':
                        ...
                        $result = $sfw->sfwUpdate($apikey, true);
                        /**
                         * @todo CRUNCH
                         */
